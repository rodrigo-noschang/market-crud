...
export class creatingRelations1645827884346 implements MigrationInterface {
    name = 'creatingRelations1645827884346'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "carts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "finished" boolean NOT NULL, CONSTRAINT "PK_b5f695a59f5ebb50af3c8160816" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "random_code" ("id" SERIAL NOT NULL, "randomCode" character varying NOT NULL, "userId" uuid, CONSTRAINT "REL_8a7bfd61bcf8b0d3f9fe60d2ad" UNIQUE ("userId"), CONSTRAINT "PK_d37cfdb249757d1a96f5ad36b80" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "random_code"`);
